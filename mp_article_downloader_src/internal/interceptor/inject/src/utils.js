 ...
 */
async function __mp_article_batch_downloader(profile) {
  console.log("__mp_article_batch_downloader");
 ...
 * @param {FeedProfile} profile 视频信息
 */
async function __mp_article_batch_downloader3(profile) {
  console.log("__mp_article_batch_downloader3");
 ...
 * @param {string} opt.suffix 后缀
 */
async function __mp_article_batch_downloader4(feed, opt) {
  console.log("__mp_article_batch_downloader4");
  ...
  if (feed.type === "picture") {
    __mp_article_batch_downloader3(feed);
    return;
  }
  if (opt.spec) {
...
${payload.key || ""}`,
  ...
  __mp_article_batch_downloader4(payload, { spec, suffix });
}
/** 下载已加载的视频 */
function __mp_article_batch_downloader_cur__() {
  ...
  __mp_article_batch_downloader(profile);
}
/** 打印下载原始文件命令 */
