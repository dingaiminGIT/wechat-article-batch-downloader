  ...
  },
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        __mp_article_batch_downloader: "writable",
        __mp_article_batch_downloader2: "writable",
        __mp_article_batch_downloader3: "writable",
        __mp_article_batch_downloader4: "writable",
