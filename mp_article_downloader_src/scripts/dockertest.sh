...
Examples:
  ...
  scripts/dockertest.sh ghcr.io/your-org/mp_article_batch_downloader:v260614
  IMAGE=ghcr.io/your-org/mp_article_batch_downloader:v260614 scripts/dockertest.sh

Environment:
  IMAGE                Full image name. Defaults to mp_article_batch_downloader:<version>.
...
IMAGE="${IMAGE:-mp_article_batch_downloader:${VERSION}}"
